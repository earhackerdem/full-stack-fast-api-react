...
Define el modelo de autorización del sistema, incluyendo verificación de usuarios activos, escalación de privilegios de superusuario, verificación de ownership de recursos, filtrado de listados, gestión de perfil propio y registro público.
## Requirements
