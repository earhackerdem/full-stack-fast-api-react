...
Define el ciclo de vida CRUD completo de items, incluyendo creación, lectura individual, listado paginado, actualización parcial, eliminación, y eliminación en cascada por usuario.
## Requirements
